...
import BsDropdownObject from './BsDropdown.PageObject';
import { isVue } from '../../utils/utils';

const { vue: BsDropdownVue, react: BsDropdownReact } = useComponent('BsDropdown');

describe('BsDropdown', () => {
  const page = () => new BsDropdownObject('dropdown');
