...
import { noop } from '@barnstormer/shared';
import { mount, useComponent } from '../../utils/mount';
import BsAccordionItemBaseObject from './BsAccordionItem.PageObject';

const { vue: BsAccordionItemVue, react: BsAccordionItemReact } = useComponent('BsAccordionItem');

describe('BsAccordionItem', () => {
  const page = () => new BsAccordionItemBaseObject('accordion-item');
