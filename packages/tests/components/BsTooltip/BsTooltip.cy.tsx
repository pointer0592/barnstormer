...
import BsTooltipObject from './BsTooltip.PageObject';

const { vue: BsTooltipVue, react: BsTooltipReact } = useComponent('BsTooltip');

describe('BsTooltip', () => {
  const page = () => new BsTooltipObject('tooltip');
  ...
  const initializeComponent = (
    ...
    return mount({
      ...
      react: (
        <BsTooltipReact label={label} className={className} showArrow={showArrow}>
          {children}
        </BsTooltipReact>
      ),
    });
