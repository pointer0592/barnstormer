...
const props = defineProps({
  ...
  size: {
    type: String as PropType<`${BsRatingButtonSize}`>,
    default: BsRatingButtonSize.base,
  },
  getLabelText: {
...
const iconSize: Record<BsRatingButtonSize, BsRatingButtonIconSize> = {
