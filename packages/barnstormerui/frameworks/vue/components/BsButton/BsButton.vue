...
import { useAttrsRef, BsButtonSize, BsButtonVariant } from '@barnstormer/vue';

const props = defineProps({
  size: {
    type: String as PropType<`${BsButtonSize}`>,
    default: BsButtonSize.base,
  },
  variant: {
    type: String as PropType<`${BsButtonVariant}`>,
    default: BsButtonVariant.primary,
  },
  disabled: {
    type: Boolean,
    default: false,
