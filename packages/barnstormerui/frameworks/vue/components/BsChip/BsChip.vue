<script lang="ts">
const sizeClasses = {
  [BsChipSize.sm]: 'text-sm py-1.5 gap-1.5',
  [BsChipSize.base]: 'text-base py-2 gap-2',
};
</script>
<script lang="ts" setup>
import { type PropType, type InputHTMLAttributes } from 'vue';
import { toRefs, computed } from 'vue';
import { useId, BsChipSize, useSlotsRef } from '@barnstormer/vue';

const props = defineProps({
  size: {
    type: String as PropType<`${BsChipSize}`>,
    default: BsChipSize.base,
  },
  modelValue: {
