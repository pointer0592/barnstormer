...
import { BsBadgePlacement, BsBadgeVariant } from '@barnstormer/vue';
...
const props = defineProps({
  ...
  placement: {
    type: String as PropType<`${BsBadgePlacement}`>,
    default: BsBadgePlacement['top-right'],
  },
  variant: {
    type: String as PropType<`${BsBadgeVariant}`>,
    default: BsBadgeVariant.standard,
  },
});
