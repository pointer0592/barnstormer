...
import { BsInputSize, useFocusVisible, type BsInputProps, polymorphicForwardRef } from '@barnstormer/react';

const defaultWrapperTag = 'span';

const sizeClasses = {
  [BsInputSize.sm]: ' h-[32px]',
  [BsInputSize.base]: 'h-[40px]',
  [BsInputSize.lg]: 'h-[48px]',
};

const BsInput = polymorphicForwardRef<typeof defaultWrapperTag, BsInputProps>(
  (
    { wrapperAs, size = BsInputSize.base, slotPrefix, slotSuffix, invalid, className, wrapperClassName, ...attributes },
    ref,
  ) => {
