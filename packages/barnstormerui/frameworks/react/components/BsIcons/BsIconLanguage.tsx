...
export default function BsIconLanguage({ size = BsIconSize.base, viewBox = '0 0 24 24', ...attributes }: BsIconProps) {
  return (
    <BsIconBase size={size} viewBox={viewBox} data-testid="language" {...attributes}>
      <path
        fillRule="evenodd"
