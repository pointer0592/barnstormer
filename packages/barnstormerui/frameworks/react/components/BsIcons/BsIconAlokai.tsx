...
export default function BsIconAlokai({ size = BsIconSize.base, viewBox = '0 0 32 32', ...attributes }: BsIconProps) {
  return (
    <BsIconBase size={size} viewBox={viewBox} data-testid="alokai" {...attributes}>
