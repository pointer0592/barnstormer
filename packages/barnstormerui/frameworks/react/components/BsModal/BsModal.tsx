...
import { type BsModalProps, polymorphicForwardRef, useTrapFocus, mergeRefs } from '@barnstormer/react';

const defaultModalTag = 'div';

const BsModal = polymorphicForwardRef<typeof defaultModalTag, BsModalProps>(
