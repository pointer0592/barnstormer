...
import { BsSelectSize, BsIconExpandMore, composeHandlers, useFocusVisible } from '@barnstormer/react';

import type { BsSelectProps } from './types';

export default function BsSelect(props: BsSelectProps) {
  const {
    ...
    >
      <select
        ...
        className={classNames(
          ...
          {
            'py-1.5': size === BsSelectSize.sm,
            'py-2': size === BsSelectSize.base,
            'py-3 text-base': size === BsSelectSize.lg,
        ...
        {placeholder && (
          <option
            ...
            className={classNames('bg-neutral-300 text-sm', {
              'text-base': size === BsSelectSize.lg,
            })}
