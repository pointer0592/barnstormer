...
import { BsButton, BsButtonVariant, BsButtonSize, BsIconExpandLess, BsIconExpandMore } from '@barnstormer/react';
    ...
    <div className={classNames(className, 'e-page-controls', { 'e-page-controls--collapsed': !previewBottomOpen })}>
      <div className="heading-wrapper">
        ...
        <BsButton
          ...
          slotSuffix={previewBottomOpen ? <BsIconExpandMore /> : <BsIconExpandLess />}
        >
