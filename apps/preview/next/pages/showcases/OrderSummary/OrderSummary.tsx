...
import { BsButton, BsIconCheckCircle, BsIconClose, BsInput, BsLink } from '@barnstormer/react';
    ...
    <div>
        ...
        <div className="px-4 pb-4 mt-3 md:px-6 md:pb-6 md:mt-0">
          ...
          {promoCode ? (
            <div className="flex items-center mb-5 py-5 border-y border-neutral-200">
              <p>PromoCode</p>
              <BsButton size="sm" variant="tertiary" className="ml-auto mr-2" onClick={removePromoCode}>
                Remove
              </BsButton>
            ...
            <form className="flex gap-x-2 py-4 border-y border-neutral-200 mb-4" onSubmit={checkPromoCode}>
              ...
              />
              <BsButton type="submit" variant="secondary">
                Apply
              </BsButton>
            </form>
          )}
          ...
          <BsButton size="lg" className="w-full">
            Place Order And Pay
          </BsButton>
      ...
      <div className="absolute top-0 right-0 mx-2 mt-2 sm:mr-6">
        {positiveAlert && (
          ...
          >
            <BsIconCheckCircle className="mr-2 my-2 text-positive-700" />
            ...
            >
              ...
              <BsIconClose size="sm" className="md:hidden block" />
            </button>
          </div>
        )}
        {informationAlert && (
