...
// #region source
import { BsInput, BsButton, BsSelect } from '@barnstormer/react';
  ...
  return (
    <form className="flex flex-col gap-y-4 text-neutral-900" onSubmit={onSubmit}>
      ...
      <label className="flex flex-col gap-y-0.5">
        ...
        <div className="flex">
          <BsSelect name="phone-country-code" className="w-16 mr-4" placeholder="--" autoComplete="tel-country-code">
            {options.map((option) => (
      ...
      <div className="flex justify-between gap-4 md:justify-end">
        <BsButton className="w-full md:w-auto" type="reset" variant="secondary">
          Clear all
        </BsButton>
        <BsButton className="w-full md:w-auto" type="submit">
          Save
        </BsButton>
      </div>
    </form>
