...
// #region source
import { BsSelect, BsInput, BsCheckbox, BsButton } from '@barnstormer/react';
    ...
    <form className="p-4 flex gap-4 flex-wrap text-neutral-900" onSubmit={onSubmit}>
      ...
      <div className="w-full flex flex-col gap-0.5 md:w-[120px]">
        <label>
          ...
          <BsInput name="aptNo" className="mt-0.5" />
        </label>
      ...
      <div className="w-full flex gap-4 mt-4 md:mt-0 md:justify-end">
        <BsButton type="reset" variant="secondary" className="w-full md:w-auto">
          Clear all
        </BsButton>
        <BsButton type="submit" className="w-full md:w-auto">
          Save
        </BsButton>
      </div>
    </form>
