...
import { BsButton, BsRatingButton, BsInput } from '@barnstormer/react';
      ...
      >
        ...
        <div className="col-span-2 md:col-start-2">
          ...
          <label className="block mb-6">
            ...
            <BsInput value={username} onChange={(event) => setUsername(event.target.value)} />
          </label>
          <div className="flex justify-end gap-x-4">
            <BsButton variant="secondary" className="flex-1 md:flex-initial">
              Cancel
            </BsButton>
            <BsButton type="submit" className="flex-1 md:flex-initial">
              Submit Review
            </BsButton>
          </div>
        </div>
