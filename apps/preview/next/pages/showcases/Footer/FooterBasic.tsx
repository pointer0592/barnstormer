...
const socialMedia = [
  ...
  },
  {
    label: 'Instagram',
    link: '#',
    icon: () => <BsIconInstagram />,
  },
  {
    label: 'Pinterest',
    link: '#',
    icon: () => <BsIconPinterest />,
  },
  {
    label: 'Youtube',
    link: '#',
...
const contactOptions = [
  {
    ...
    icon: () => <BsIconHelp size="lg" />,
  },
  {
    label: 'Live chat',
    link: '#',
    details: ['Mon–Fri, 5am–10pm PT', 'Sat–Sun, 6am–9pm PT'],
    icon: () => <BsIconContactSupport size="lg" />,
  },
  {
    label: '1 234 567 8901',
    link: '#',
    details: ['Mon–Fri, 5am–10pm PT', 'Sat–Sun, 6am–9pm PT'],
    icon: () => <BsIconCall size="lg" />,
  },
];
const bottomLinks = [
  {
        ...
        {categories.map(({ label, subcategories }) => (
          <ul className="grid grid-cols xs:pb-4" key={label}>
            ...
            {subcategories?.map(({ subcategoryLabel, link }) => (
              <BsListItem className="py-2 !bg-transparent typography-text-sm font-body" key={subcategoryLabel}>
                <BsLink
