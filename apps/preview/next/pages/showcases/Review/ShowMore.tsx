...
// #region source
import { BsRating, BsIconCheck, BsIconThumbUp, BsIconThumbDown, BsCounter } from '@barnstormer/react';
      ...
      <footer className="flex items-center justify-between">
        <div className="text-sm text-neutral-500">
          <button type="button" className="mr-6 hover:text-primary-800">
            <BsIconThumbUp size="sm" className="mr-2.5" />
            <BsCounter size="sm" className="text-inherit">
              6
            </BsCounter>
          </button>
          <button type="button" className="hover:text-primary-800">
            <BsIconThumbDown size="sm" className="mr-2.5" />
            <BsCounter size="sm" className="text-inherit">
              2
            </BsCounter>
          </button>
