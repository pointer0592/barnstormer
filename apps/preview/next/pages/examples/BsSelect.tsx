import { BsSelect, BsSelectSize, BsSelectProps } from '@barnstormer/react';
...
function Example() {
  const { state, controls } = prepareControls<
    BsSelectProps & { label: string; options: { label: string; value: string }[] }
  >(
    [
      {
        type: 'json',
  ...
  return (
    <ComponentExample controls={{ state, controls }}>
      <label>
        ...
        <BsSelect {...state.get} onChange={onChange}>
