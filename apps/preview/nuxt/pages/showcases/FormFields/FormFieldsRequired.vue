  ...
  <div class="px-4">
    ...
    <form @submit.prevent="sendForm">
      <label class="flex justify-between cursor-pointer mb-4 gap-2">
        ...
        <BsSwitch v-model="personalInformationModelValue" />
      </label>
      <label>
      ...
      <label>
        ...
        <BsInput v-model="websiteModelValue">
          <template #prefix>
            <span>https://</span>
          </template>
        </BsInput>
      ...
      <div ref="dropdownReferenceRef" class="relative mb-4">
        ...
        >
          ...
          >
            {{ option.label }}
            <template #suffix>
              <BsIconCheck v-if="option.value === selectedOption?.value" class="text-primary-700" />
            </template>
          </BsListItem>
        </ul>
      </div>
      ...
      <fieldset>
        ...
        >
          <BsCheckbox v-model="emailNotificationsModelValue" :disabled="disabled" :value="value" class="m-0.5" />
          <span class="ml-2">
      ...
      <div class="flex gap-x-4 md:justify-end mt-6">
        <BsButton variant="secondary" class="flex-grow md:flex-grow-0"> Clear all </BsButton>
        <BsButton type="submit" class="flex-grow md:flex-grow-0"> Submit </BsButton>
      </div>
    </form>
  </div>
</template>
