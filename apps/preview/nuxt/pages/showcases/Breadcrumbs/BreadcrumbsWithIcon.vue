  ...
  <nav class="inline-flex items-center text-sm font-normal font-body">
    <ol class="flex w-auto leading-none group md:flex-wrap">
      <li class="flex items-center sm:hidden text-neutral-500">
        <BsDropdown v-model="dropdownOpened" strategy="absolute" placement="bottom-start" @update:model-value="close">
          <template #trigger>
            <BsButton
...
import { BsDropdown, BsButton, BsLink, BsIconMoreHoriz, BsIconHome } from '@barnstormer/vue';
import { ref } from 'vue';
