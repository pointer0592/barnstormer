<template>
  <div class="relative">
    <div class="bg-neutral-100 p-4 sm:p-10 text-center">
      ...
      >
        <BsInput v-model="inputValue" type="email" wrapper-class="grow" placeholder="Type your email" />
        <BsButton type="submit" size="lg"> Subscribe to Newsletter </BsButton>
      </form>
      <div class="typography-text-xs text-neutral-600">
        To learn how we process your data, visit our <BsLink href="#" class="!text-neutral-600">Privacy Notice</BsLink>.
        You can <BsLink href="#" class="!text-neutral-600">unsubscribe</BsLink> at any time without costs.
      </div>
    </div>
...
import { BsButton, BsInput, BsLink, BsIconCheckCircle, BsIconClose } from '@barnstormer/vue';
