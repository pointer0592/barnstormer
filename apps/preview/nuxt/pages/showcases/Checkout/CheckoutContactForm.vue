<template>
  <form class="flex flex-col gap-y-4 text-neutral-900" @submit.prevent="onSubmit">
    ...
    <label class="flex flex-col gap-y-0.5">
      ...
      <div class="flex">
        <BsSelect name="phone-country-code" class="w-16 mr-4" placeholder="--" auto-complete="tel-country-code">
    ...
    <div class="flex justify-between gap-4 md:justify-end">
      <BsButton class="w-full md:w-auto" type="reset" variant="secondary"> Clear all </BsButton>
      <BsButton class="w-full md:w-auto" type="submit">Save</BsButton>
    </div>
  </form>
</template>
...
import { ref } from 'vue';
import { BsInput, BsButton, BsSelect } from '@barnstormer/vue';
