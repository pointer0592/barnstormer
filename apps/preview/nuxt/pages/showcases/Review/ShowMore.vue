    ...
    <header class="flex flex-col pb-2 md:flex-row md:justify-between">
      <div class="flex flex-col items-start">
        <span class="flex items-center pr-2 text-xs text-neutral-500">
          <BsRating :value="5" :max="5" size="xs" class="mr-2" />
          2 days ago
        </span>
      </div>
      <div class="flex items-end">
        <p class="flex items-center text-xs truncate text-primary-700">
          ...
          <BsIconCheck size="xs" class="mr-1" /> Verified purchase
        </p>
      </div>
    </header>
    ...
    <footer class="flex items-center justify-between">
      <div class="text-sm text-neutral-500">
        <button type="button" class="mr-6 hover:text-primary-800">
          <BsIconThumbUp size="sm" class="mr-2.5" />
          <BsCounter size="sm" class="text-inherit">6</BsCounter>
        </button>
        <button type="button" class="hover:text-primary-800">
          <BsIconThumbDown size="sm" class="mr-2.5" />
          <BsCounter size="sm" class="text-inherit">2</BsCounter>
        </button>
      </div>
...
import { BsRating, BsIconCheck, BsIconThumbUp, BsIconThumbDown, BsCounter } from '@barnstormer/vue';
