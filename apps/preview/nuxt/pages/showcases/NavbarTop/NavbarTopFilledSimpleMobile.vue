<template>
  <header class="flex justify-center w-full py-2 px-4 lg:py-5 lg:px-6 bg-primary-700 border-b border-neutral-200">
    ...
    >
      <BsButton variant="tertiary" square class="md:hidden text-white" aria-label="Go back">
        <BsIconArrowBack />
      </BsButton>
      <a
        href="#"
      ...
      <BsButton variant="tertiary" square class="md:hidden text-white" aria-label="Search">
        <BsIconSearch />
      </BsButton>
      <BsButton
