  ...
  <div class="flex border-b-[1px] border-neutral-200 hover:shadow-lg min-w-[320px] max-w-[640px] p-4">
    <div class="relative overflow-hidden rounded-md w-[100px] sm:w-[176px]">
      ...
      <div class="absolute top-0 left-0 text-white bg-secondary-600 py-1 pl-1.5 pr-2 typography-text-xs font-medium">
        <BsIconSell size="xs" class="mr-1" />
        Sale
      </div>
    </div>
    <div class="flex flex-col pl-4 min-w-[180px] flex-1">
      <BsLink href="#" variant="secondary" class="no-underline typography-text-sm sm:typography-text-lg">
...
import { ref } from 'vue';
import { BsLink, BsButton, BsIconSell, BsIconAdd, BsIconRemove, BsIconDelete, useId } from '@barnstormer/vue';
