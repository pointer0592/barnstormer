    ...
    >
      ...
      <div class="col-span-2 md:col-start-2">
        <div class="flex items-center justify-between">
          ...
          <BsRatingButton v-model="ratingModelValue" :aria-labelledby="ratingLabelId" class="p-1 gap-x-2" />
        </div>
        ...
        <label class="block mb-6">
          ...
          <BsInput v-model="usernameModelValue" />
        </label>
        <div class="flex justify-end gap-x-4">
          <BsButton variant="secondary" class="flex-1 md:flex-initial">Cancel</BsButton>
          <BsButton type="submit" class="flex-1 md:flex-initial">Submit Review</BsButton>
        </div>
      </div>
    </form>
  </div>
...
import { BsButton, BsRatingButton, BsInput, useId } from '@barnstormer/vue';
