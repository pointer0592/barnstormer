<template>
  ...
  >
    <BsIconCheckCircle class="my-2 mr-2 text-positive-700 shrink-0" />
    ...
    >
      ...
      <BsIconClose size="sm" class="block md:hidden" />
    </button>
  </div>
</template>

<script lang="ts" setup>
import { BsIconCheckCircle, BsIconClose } from '@barnstormer/vue';
</script>
