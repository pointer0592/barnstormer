  ...
  <div class="flex gap-x-10">
    <fieldset role="radiogroup">
      <div class="flex flex-col">
        ...
        >
          <BsRadio v-model="radioGroupModelValue" :value="value" :name="name" />
    ...
    <fieldset role="radiogroup">
      <div class="flex flex-row">
        ...
        >
          <BsRadio v-model="radioGroupTwoModelValue" :value="value" :name="name" />
          <span class="ml-2 text-base font-normal leading-6 font-body">{{ label }}</span>
        </label>
      </div>
    </fieldset>
...
import { ref } from 'vue';
import { BsRadio } from '@barnstormer/vue';
