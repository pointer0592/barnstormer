...
```tsx
import { usePagination, BsButton, BsIconChevronLeft, BsIconChevronRight } from '@barnstormer/react';
...
import { usePagination, BsIconChevronRight, BsIconChevronLeft, BsButton } from '@barnstormer/vue';
...
::react-only
<<<../../../../../packages/barnstormerui/frameworks/react/hooks/usePagination/usePagination.ts
::
::vue-only
<<<../../../../../packages/barnstormerui/frameworks/vue/composables/usePagination/usePagination.ts
::
